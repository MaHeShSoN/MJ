...
class Baajubandh : AppCompatActivity(), ImageViewer, ButtonClicer {
...
//    lateinit var mProBar: ProgressBar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_baajubandh)
        try {
            supportActionBar!!.setBackgroundDrawable(ColorDrawable(resources.getColor(R.color.gold)))

            mSRef = FirebaseStorage.getInstance().getReference("baajubandh")
            mDbRef = FirebaseDatabase.getInstance().getReference("uploads")
            supportActionBar!!.title = "बाजूबंद"


            db = FirebaseFirestore.getInstance()
            imgCollections = db.collection("baajubandh")
...
//            Picasso.get().load(mImageUri).into(mImageView)
    ...
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_baajubandh)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@Baajubandh)
                    val layoutInflaterAndroid = LayoutInflater.from(this@Baajubandh)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@Baajubandh ,image)
