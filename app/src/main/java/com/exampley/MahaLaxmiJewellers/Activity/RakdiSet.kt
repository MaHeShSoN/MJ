...
class RakdiSet : AppCompatActivity(), ImageViewer, ButtonClicer {
...
//    lateinit var mProBar: ProgressBar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            imgCollections = db.collection("rakdiset")
...
//            Picasso.get().load(mImageUri).into(mImageView)
    ...
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_rakdi_set)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@RakdiSet)
                    val layoutInflaterAndroid = LayoutInflater.from(this@RakdiSet)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@RakdiSet ,image)
