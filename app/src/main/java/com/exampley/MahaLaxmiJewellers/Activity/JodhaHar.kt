...
class JodhaHar : AppCompatActivity(), ImageViewer, ButtonClicer {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            imgCollections = db.collection("jodhahar")
...
//    }
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_jodhahar)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@JodhaHar)
                    val layoutInflaterAndroid = LayoutInflater.from(this@JodhaHar)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@JodhaHar, image)
