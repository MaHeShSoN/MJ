...
class Hathful : AppCompatActivity(), ImageViewer, ButtonClicer {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            imgCollections = db.collection("hathful")
...
//    }
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_hatful)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@Hathful)
                    val layoutInflaterAndroid = LayoutInflater.from(this@Hathful)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@Hathful, image)
