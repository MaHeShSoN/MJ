...
class Ramnavmi : AppCompatActivity(), ImageViewer, ButtonClicer {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            imgCollections = db.collection("ramnavmi")
...
//    }
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_ramnavmi)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@Ramnavmi)
                    val layoutInflaterAndroid = LayoutInflater.from(this@Ramnavmi)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@Ramnavmi, image)
