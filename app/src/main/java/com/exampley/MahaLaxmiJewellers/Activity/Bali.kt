...
class Bali : AppCompatActivity(), ImageViewer, ButtonClicer {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            mSRef = FirebaseStorage.getInstance().getReference("bali")
            mDbRef = FirebaseDatabase.getInstance().getReference("uploads")
            supportActionBar!!.title = "बाली"
            ...
            imgCollections = db.collection("bali")
...
//    }
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_bali)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@Bali)
                    val layoutInflaterAndroid = LayoutInflater.from(this@Bali)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@Bali, image)
