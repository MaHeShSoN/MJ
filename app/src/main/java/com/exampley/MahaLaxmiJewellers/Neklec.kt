package com.exampley.MahaLaxmiJewellers
...
class Neklec : AppCompatActivity(), ImageViewer, ButtonClicer {
    ...
    lateinit var mimageUri_send: Uri
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_neklec)

        try {
            supportActionBar!!.setBackgroundDrawable(ColorDrawable(resources.getColor(R.color.gold)))

            mSRef = FirebaseStorage.getInstance().getReference("nekles")
            mDbRef = FirebaseDatabase.getInstance().getReference("uploads")
            supportActionBar!!.title = "नेक्लैक"


            db = FirebaseFirestore.getInstance()
            imgCollections = db.collection("nekles")
...
//            Picasso.get().load(mImageUri).into(mImageView)
    ...
    //    override  protected fun onLoadingStateChanged(state: LoadingState) {
//        when (state) {
//            LoadingState.LOADING_INITIAL -> homeRecyclerViewProgressBar.setVisibility(View.VISIBLE)
//            LoadingState.LOADING_MORE, LoadingState.LOADED -> homeRecyclerViewProgressBar.setVisibility(
//                View.GONE
//            )
//            LoadingState.FINISHED -> homeRecyclerViewProgressBar.setVisibility(View.GONE)
...
//    }
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_neklec)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@Neklec)
                    val layoutInflaterAndroid = LayoutInflater.from(this@Neklec)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@Neklec, image)
