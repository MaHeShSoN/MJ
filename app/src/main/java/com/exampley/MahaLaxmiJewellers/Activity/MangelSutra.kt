...
class MangelSutra : AppCompatActivity(), ImageViewer, ButtonClicer {
...
//    lateinit var mProBar: ProgressBar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mangel_sutra)
        try {
            supportActionBar!!.setBackgroundDrawable(ColorDrawable(resources.getColor(R.color.gold)))

            mSRef = FirebaseStorage.getInstance().getReference("manglesutra")
            ...
            supportActionBar!!.title = "मंगलसूत्र"

            db = FirebaseFirestore.getInstance()
            imgCollections = db.collection("manglesutra")
...
//            Picasso.get().load(mImageUri).into(mImageView)
    ...
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_mangelsutra)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@MangelSutra)
                    val layoutInflaterAndroid = LayoutInflater.from(this@MangelSutra)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@MangelSutra ,image)
