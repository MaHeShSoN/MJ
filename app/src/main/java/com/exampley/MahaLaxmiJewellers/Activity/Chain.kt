...
class Chain : AppCompatActivity(), ImageViewer, ButtonClicer {
...
//    lateinit var mProBar: ProgressBar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            mSRef = FirebaseStorage.getInstance().getReference("chain")
            mDbRef = FirebaseDatabase.getInstance().getReference("uploads")

            supportActionBar!!.title = "चैन"
            try{
            ...
            imgCollections = db.collection("chain")
...
//            Picasso.get().load(mImageUri).into(mImageView)
    ...
    private fun setUpRecyclerView() {
        ...
        try {
            mRecyclerView = findViewById(R.id.recycler_view_chain)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            docRef.get().await().reference.addSnapshotListener { value, error ->
                ...
                shareButton.setOnClickListener {
                    val builder: AlertDialog.Builder = AlertDialog.Builder(this@Chain)
                    val layoutInflaterAndroid = LayoutInflater.from(this@Chain)
                    ...
                    view.findViewById<TextView>(R.id.send_papa).setOnClickListener {
                        ...
                        val uri = getImageUri(this@Chain ,image)
